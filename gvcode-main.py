...
class GraphicVerificationCode(object):
    ...
    def generate(self, size=(120, 30), chars=None, format='PNG', mode='RGB', bg_color=(255, 255, 255), fg_color=(0, 0, 255), font_size=24, font_file='Algerian', length=4, draw_lines=True, line_range=(5, 8), draw_points=True, point_chance=2):
        ...
        def create_line():
            """ 绘制干扰线 """
            draw.line([random_dot(), random_dot()], fill=(150, 150, 150))
        ...
        def create_points():
            ...
            [draw.point((w, h), fill=(150, 150, 150)) for w in range(width) for h in range(height) if random.randint(0, 100) < chance]
        ...
        def create_chars():
            ...
            xy = ((width - font_width) / 10, (height - font_height) / 10)
